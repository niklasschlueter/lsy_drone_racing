...
class Plotter:
    ...
    def plot_velocity(self):
        ...
        ax.plot(
            timesteps, df.iloc[:, DataVarIndex.VEL_X.value], "-", label=r"$v_{x, meas}$"
        )
        ax.plot(
            timesteps,
        ...
        ax.plot(
            timesteps, df.iloc[:, DataVarIndex.VEL_Y.value], "-", label=r"$v_{y, meas}$"
        )
        ax.plot(
            timesteps,
        ...
        ax.plot(
            timesteps, df.iloc[:, DataVarIndex.VEL_Z.value], "-", label=r"$v_{z, meas}$"
        )
        ax.plot(
            timesteps,
    ...
    def plot_data_single_it(
        ...
        plot_names.append("Computation Time")

        fig = figs.append(self.plot_total_thrust_internal())
        plot_names.append("Total Thrust Internal")
